...
import import_file.CVSDbUtil;

public class CVSDbUtil {
	private static CVSDbUtil instance;
	private DataSource dataSource;
	private String jndiName = "java:comp/env/jdbc/qcm";
	
	public static CVSDbUtil getInstance() throws Exception {
		if (instance == null) {
			instance = new CVSDbUtil();
		}
		
		return instance;
	}
	
	private CVSDbUtil() throws Exception {		
